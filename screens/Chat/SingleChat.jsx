...
//   wsHost: 'http://192.168.254.106', // change to your backend domain or IP
//   wsPort: 443,
//   forceTLS: true,
//   encrypted: true,
//   disableStats: true,
//   authEndpoint: 'http://192.168.254.106/broadcasting/auth',
//   auth: {
//     headers: {
...
//     axios
//       .get(`http://192.168.254.106/api/agent/chat/channels/${channelId}`, {
//         headers: {
...
//     axios
//       .post(
//         `http://192.168.254.106/api/agent/chat/channels/${channelId}/send`,
//         { message: newMessage },
//         {
//           headers: {
//             Authorization: `Bearer YOUR_AUTH_TOKEN`,
